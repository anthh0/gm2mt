...
ring = Ring(
    ...
    b_k = Kicker("file", "traces-Ir", b_norm = 204, kick_max = 4, kicker_num = 3),
...
generator = StateGenerator(
    ...
    # t = dist.Custom(dir = "pulseshape_1_12543_mod", zero = list(np.linspace(24797.5, 24857.5, 7)))
)
# generator = StateGenerator(
#     mode = "bmad",
